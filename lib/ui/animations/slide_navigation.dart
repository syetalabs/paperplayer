...
class SlideRightRoute extends MaterialPageRoute {
  ...
  SlideRightRoute({this.previousPage, WidgetBuilder builder, RouteSettings settings}) : super(builder: builder, settings: settings);
...
class SlideLeftRoute extends MaterialPageRoute {
  final Widget previousPage;
  SlideLeftRoute({this.previousPage, WidgetBuilder builder, RouteSettings settings}) : super(builder: builder, settings: settings);
